...
class FigurineManagement{
     ...
     * @param zone : la zone concernee.
     * @param player : le joueur concerne, zone : la zone concernee.
     * @param number : le nombre de figurine a placer.
     * @param indexZone : l'index de la zone correspondante.
     */ 
     ...
     * @param zone : la zone concernee. 
     * @param player : le joueur qui recupere les figurines. 
     */ 
